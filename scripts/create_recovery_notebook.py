"""
Creates a small recovery notebook that ONLY does Steps 9 & 10:
- Loads the saved checkpoint from Google Drive
- Saves LoRA adapters
- Exports GGUF model for Ollama
- Tests the model
"""
import json
...
cells.append({
    "cell_type": "markdown",
    "metadata": {},
    "source": ["## Step 1: Install Dependencies (~3 min)"]
})
...
cells.append({
    "cell_type": "markdown",
    "metadata": {},
    "source": ["## Step 2: Mount Google Drive & Find Checkpoint"]
})
...
# --- Cell 3: Load base model + checkpoint ---
cells.append({
    "cell_type": "markdown",
    "metadata": {},
    "source": [
...
# --- Cell 4: Save LoRA (Step 9a) ---
cells.append({
    "cell_type": "markdown",
    "metadata": {},
    "source": ["## Step 4: Save LoRA Adapters (Step 9)"]
})
...
cells.append({
    "cell_type": "markdown",
    "metadata": {},
    "source": ["## Step 6: Test the Fine-Tuned Model (Step 10)"]
})
...
output_path = "recovery_save_model.ipynb"
